        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              <h1 className="text-2xl font-semibold tracking-tight">Meta Ads Workflow</h1>
              <p className="text-sm text-muted-foreground mt-2 max-w-sm">
                Analysiere deine Ads, recherchiere Konkurrenten und erstelle professionelle Skripte – alles in einem Dashboard.
              </p>
            </div>
          </div>
          <Button
                ...
                return (
                  <SidebarMenuItem key={item.path}>
                    ...
                    >
                      ...
                      {item.path === "/connect" && !isCollapsed && (
                        <span className="ml-auto">
                          {connection ? (
                            <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 block" />
                          ) : (
                            <span className="h-1.5 w-1.5 rounded-full bg-muted-foreground/40 block" />
                          )}
                        </span>
                      )}
                    </SidebarMenuButton>
